...
rule recalculate_and_assemble:
    ...
    output:
        prefix + "processed/profiles{sens_version}.RData",
    shell:
        """
...
rule process_raw_sens_data:
    input:
        ...
        prefix + "processed/drugInfo.RData",
        prefix + "processed/drugInfo_8.2.RData",
        prefix + "processed/cellInfo.RData",
        prefix + "processed/cellInfo_8.2.RData"
    output:
        prefix + "processed/{data_ver}_sens_info.rds",
        prefix + "processed/{data_ver}_sens_raw.rds",
